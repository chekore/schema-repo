 ...
 * {@link #register(String, SubjectConfig)}, which requires the subject name and
 * its configuration. The configuration is a map of configuration keys to
 * configuration values, both of which are Strings.
 */
