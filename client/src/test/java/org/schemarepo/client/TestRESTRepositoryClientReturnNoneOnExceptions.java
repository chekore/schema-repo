...
/**
 * Tests {@link org.schemarepo.client.RESTRepositoryClient} configured to return a 'none' (e.g. null or empty collection)
 * values in case of any remote errors encountered while talking to the server.
 */
