...
/**
 * A marker interface for all repository clients to be distinguishable from other repository implementations.
 */
public interface RepositoryClient extends Repository {
   ...
   * Details such as "what" and "representation" are up to the implementing classes.
